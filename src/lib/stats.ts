...
const categories = {
  ...
  document: ['doc', 'docx', 'ppt', 'pptx', 'xls', 'xlsx', 'csv', 'pdf', 'txt'],
  archive: ['zip', 'rar', 'tar', 'gz', '7z'],
  markdown: ['md', 'markdown', 'mdown', 'mkdn', 'mkd', 'mdwn', 'mdtxt', 'mdtext', 'text'],
  config: ['env', 'env.local', 'conf', 'config', 'cfg', 'ini',],
  log: ["log"],
  container: ['dockerfile', 'dockerignore', 'docker-compose.yml', 'docker-compose.yaml', 'docker-compose.json', 'docker-compose.json',],
  code: ['html', 'css', 'js', 'ts', 'jsx', 'tsx', 'json', 'py', 'java', 'c', 'cpp', 'h', 'hpp', 'cs', 'go', 'php', 'rb', 'rs', 'sh', 'swift', 'vb', 'xml', 'yml', 'yaml', 'sql', 'pl', 'm', 'mjs', 'jsx', 'tsx', 'cjs', 'asm', 'bat', 'cmd', 'ps1', 'psm1', 'psd1', 'ps1xml', 'psc1', 'pssc', 'cdxml', 'xaml', 'xaml', 'wsf', 'psc2', 'reg', 'rgs', 'inf', 'ins', 'isp', 'wsc', 'wsh', 'cer', 'crt', 'der', 'pfx', 'p12', 'p7b', 'p7r', 'spc', 'gpg', 'asc', 'jks', 'keystore', 'crtx', 'key', 'pem', 'csr', 'p7c', 'p7m', 'p7s', 'p8', 'p10', 'pki', 'p7', 'p7a', 'p7d', 'p7f', 'p7w', 'p7z', 'p8', 'p8e', 'p8s', 'p8r', 'p8m', 'p8d', 'p8f', 'p8w', 'p8z', 'p8a', 'p8b', 'p8c', 'p8x', 'p8y', 'p8t', 'p8q', 'p8i', 'p8j', 'p8k', 'p8l', 'p8n', 'p8o', 'p8p', 'p8u', 'p8v', 'p8w', 'p8x', 'p8y', 'p8z', 'p8a', 'p8b', 'p8c', 'p8d', 'p8e', 'p8f', 'p8g', 'p8h', 'p8i', 'p8j', 'p8k', 'p8l', 'p8m', 'p8n', 'p8o', 'p8p', 'lockb', 'gitignore', ''],
  executable: ['exe', 'msi'],
